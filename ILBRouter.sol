...
interface ILBRouter {
    ...
    error LBRouter__InvalidLockDuration();
    ...
    /**
     * @dev Fee collection parameters
     */
    struct FeeCollectionParameters {
        IERC20 tokenX;
        IERC20 tokenY;
        uint16 binStep;
        uint256[] ids;
     ...
     * @dev Fee collection parameters
     */
    struct RewardCollectionParameters {
        IERC20 tokenX;
        IERC20 tokenY;
        uint16 binStep;
        uint256[] ids;
    ...
    function collectFeesBatch(
        FeeCollectionParameters[] calldata feeCollectionParameters
    ) external returns (uint256[] memory amountsX, uint256[] memory amountsY);
    ...
    function collectRewards(
        ...
        uint256[] calldata ids,
        address to
    ) external returns (uint128[][] memory rewardAmounts);

    function collectRewardsBatch(
        RewardCollectionParameters[] calldata rewardCollectionParameters
    ) external returns (uint128[][][] memory allRewardAmounts);
    ...
    function getPendingFees(
        ...
        address account,
        uint256[] calldata ids
    ) external view returns (uint128[] memory feesX, uint128[] memory feesY);
    ...
    function getPendingRewards(
        ...
        address account,
        uint256[] calldata ids
    ) external view returns (uint128[][] memory rewards);

    function getRewardEmissions(
        IERC20 tokenX,
        IERC20 tokenY,
        uint16 binStep
    ) external view returns (uint256[] memory emissions);

    function getInfoRewarder(
        IERC20 tokenX,
        IERC20 tokenY,
        uint16 binStep,
        uint256 index
